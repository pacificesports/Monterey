...
func InitializeDB() {
	...
	if err != nil {
		...
		db.AutoMigrate(&model.Organization{}, &model.OrganizationUser{}, &model.OrganizationUserRole{}, &model.TeamOrganization{}, &model.Team{}, &model.TeamUser{}, &model.TeamUserRole{})
